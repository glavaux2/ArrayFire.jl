...
export AF_NORM_VECTOR_INF, AF_NORM_VECTOR_P, AF_PAD_SYM, AF_PAD_ZERO, AF_PAD_CLAMP_TO_EDGE, AF_PAD_PERIODIC
export AF_RANDOM_ENGINE_DEFAULT, AF_RANDOM_ENGINE_MERSENNE
